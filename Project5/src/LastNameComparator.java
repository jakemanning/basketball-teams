 ...
 * <P>
 * LastNameComparator compares one last name to another last name in specific
 * ways
 * </P>
...
public class LastNameComparator implements Comparator<Person> {
	 ...
	 * 
	 * @param person
	 *            :a person who contains first or last names (Person)
	 * @param anotherPerson
	 *            :another person who contains first or last names (Person)
