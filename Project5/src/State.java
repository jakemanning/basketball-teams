...
* March 27, 2015
* <P>
* Contains the Place, including the city and state, and allows this data to be sorted based on user input
* </P>
...
public class State implements Comparable<State>, Serializable
{
	...
	/**
	 * Constructs a State Object from the String stateOfBirth and an ArrayList of City objects
	 *<P>
	 * @param stateName The state. (String)
	 */
	...
	/**
	 * Compares two State Objects alphabetically to see where to place an object that needs to be added
	 * <P>
	 * @param o :the Object which is casted to a place object to be compared. (Object)
	 * @return Numerical value in which to indicate the order the States should appear. (int)
	 */
	 ...
	 * <P>
	 * @param cityToAdd :City of the particular Person. (City)
	 * @return cityOfBirth : City as a City Object. (City)
	 */
	public City addToList(City cityToAdd)
	{
		City city = MapClass.putInMapListIfAbsent(listOfCities,cityToAdd.getCityName().toUpperCase() + cityToAdd.getStateName().toUpperCase(),cityToAdd);
		
		return city;
	}//End of List Method.
	
	/**
	 * Returns the list of cities that is needed when searching through an entire state.
	 * <P>
