 ...
 * <P>
 * Contains the City of the Person and allows this data to be sorted based on
 * user input
 * </P>
...
public class City implements Comparable<City>, Serializable {
	 ...
	 * 
	 * @param cityName
	 *            City of the person. (String)
	 * @param state
	 *            State of the person. (State)
	 * @param shouldEdit
	 *            whether the City should be edited
	 */
	...
	// * <P>
	// * @param personToAdd : The name of the person to add to the list.
	// (Person)
	// */
	 ...
	 * <P>
	 * Algorithm:<br>
	 * 1. See if an object is before, after, or equal to another by comparing
	 * them using the compareTo method<br>
	 * <P>
	 * 
	 * @param o
	 *            the Object which is casted to a place object to be compared
	 *            (Object)
	 * @return A 0 if they are the same, or a positive/negative number depending
	 *         on if one is after or before the other. (int)
	 */
