...
* March 27, 2015
* <P>
* Creates each Team by compiling all the needed attributes. This includes a Team Name,
* City and an ArrayList of team members.
* </P>
* @version 1.0
*/
...
{	
	...
	/**
	 * Constructs a Team object which contains the name of the team, the city of the team, and the state of the team.
	 * <P>
	 * @param teamYear the year the season indicates for the team
	 * @param teamName The name of each team as a String.
	 * @param teamCity The city of each team as a String.
	 * @param roster   List of Person that belong to a specific Team.
	 * @param shouldEdit whether the season should be edited or not; aka should be constant	
	 */
	...
	{	
		...
		return this.teamYear + "; " + this.teamName + "; " + this.teamCity + "; " + this.teamCity.getState() + rosterForSaving; 
