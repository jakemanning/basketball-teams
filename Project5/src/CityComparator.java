...
public class CityComparator implements Comparator<City>
{
	...
	* <P>
	* @param city the first city to compare to
	* @param anotherCity the second city to compare to
	* @return positive if it is after what you're comparing, 0 if at same place, negative if it is before
	*/
