...
public class EditPersonView extends JFrame {
	...
	JButton personStateButton = new JButton();
	JLabel personSelectCityLabel = new JLabel("Select City:");
	JButton personCityButton = new JButton();
	...
	public EditPersonView(String personName) {
		setTitle("Editing: " + personName);
