...
public class MainView extends JFrame
{
	...
	/**
	 * Gets the JMenuItem for the Age Selection of the Graph Menu for the Action Listener.
	...
	/**
	 * Gets the JMenuItem for the Location Selection of the Graph Menu for the Action Listener.
